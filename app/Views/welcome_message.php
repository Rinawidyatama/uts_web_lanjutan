...
<head>
    <meta charset="UTF-8">
    <title> Selamat Datang di Website Rina Dwi Susanti</title>
    ...
    <header>
        ...
        <div class="menu">
            <ul>
                ...
                <li class="menu-item hidden"><a href="aboutme" target="_blank">About me</a>
                </li>
                <li class="menu-item hidden"><a href="edukasi" target="_blank">Education</a></li>
        ...
        <div class="heroe">
            ...
            <h1>Welcome to Website Rina Dwi Susanti</h1>

            <h2>Perkenalkan nama saya Rina Dwi Susanti</h2>

            <a href="aboutme" class="btn btn-sm btn-outline-secondary">About This page</a>
